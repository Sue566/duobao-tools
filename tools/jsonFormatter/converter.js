...
(function() {
      ...
      try {
        ...
        switch (conversionType) {
          ...
          case 'yaml-to-json':
            ...
            convertResult.innerHTML = window.jsonFormatter.utils.syntaxHighlight(formattedJson);
            break;
          case 'json-to-xml':
          ...
          case 'xml-to-json':
            ...
            convertResult.innerHTML = window.jsonFormatter.utils.syntaxHighlight(xmlToJsonFormatted);
            break;
          case 'json-to-csv':
          ...
          case 'csv-to-json':
            ...
            convertResult.innerHTML = window.jsonFormatter.utils.syntaxHighlight(csvToJsonFormatted);
            break;
          default:
  ...
  window.jsonFormatter.converter = converter;
})();